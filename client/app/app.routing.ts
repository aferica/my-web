...
const appRoutes: Routes = [
  ...
  { path: 'image/qingchu', component: QingchunComponent },
  { path: 'image/xinggan', component: XingganComponent },
  { path: 'image/xindong', component: XindongComponent },
  { path: 'image/zhenhan', component: ZhenhanComponent },
